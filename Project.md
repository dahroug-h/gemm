**The Accuracy Tax: How expanding the INT8 range reduces the performcance by 30% oneDNN as an example"** is pure gold.

- quantization to int8 is important to boost llms performance
